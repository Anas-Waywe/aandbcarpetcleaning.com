...
@include('inc.header',[
            'title' => 'Window Treatment - A&B Carpet Cleaning',
            'description' => 'Professional window treatment services including cleaning and maintenance for shades, blinds, and drapes.',
...
.hero-section {
    width: 100%;
    position: relative;
    background-image: url('/images/services images/heroo section/Window Treatment feature image.webp');
    ...
    <div class="why-professional-container">
        ...
        <div class="why-professional-left">
            <div class="why-professional-image-container">
                                 <img class="why-professional-image" alt="Professional window treatment" src="/images/services images/why professional section/Why Professional Window Cleaning is Important.webp">
            </div>
        </div>
    ...
    <div class="before-after-container">
        ...
        <div class="before-after-content">
            <div class="before-after-images">
                     ...
                     <img src="/images/services images/before after/Window Treatment Imgs/window treatment before.webp" alt="Window Treatment Before">
                     <div class="image-label before-label">Before</div>
                 </div>
                 <div class="after-image">
                     <img src="/images/services images/before after/Window Treatment Imgs/window treatment after.webp" alt="Window Treatment After">
    ...
    <div class="what-make-us-trusted-container">
        <div class="what-make-us-trusted-left">
            <div class="trusted-image">
                <img src="/images/services images/What Make Us Trusted.webp" alt="Trusted window treatment service">
            </div>
        </div>
