...
@include('inc.header',[
            'title' => 'Allergy Control - A&B Carpet Cleaning',
            'description' => 'Allergy control cleaning services to reduce allergens, dust mites, and improve indoor air quality.',
...
.hero-section {
    width: 100%;
    position: relative;
    background-image: url('/images/services images/hero section/Allergy Control feature image.webp');
    ...
    <div class="why-professional-container">
        ...
        <div class="why-professional-left">
            <div class="why-professional-image-container">
                                 <img class="why-professional-image" alt="Professional allergy control" src="/images/why and what section/Services 1st & 2nd imges/Allergy Control/Allergy control Services 1st img.webp">
            </div>
        </div>
    ...
    <div class="before-after-container">
        ...
        <div class="before-after-content">
            <div class="before-after-images">
                     ...
                     <img src="/images/services images/before after/Allergy Control Carpet Imgs/Allergy Control Before.webp" alt="Allergy Control Before">
                     <div class="image-label before-label">Before</div>
                 </div>
                 <div class="after-image">
                     <img src="/images/services images/before after/Allergy Control Carpet Imgs/Allergy Control After.webp" alt="Allergy Control After">
    ...
    <div class="what-make-us-trusted-container">
        <div class="what-make-us-trusted-left">
            <div class="trusted-image">
                <img src="/images/services images/What Make Us Trusted.webp" alt="Trusted allergy control service">
            </div>
        </div>
